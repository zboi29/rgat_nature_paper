...
\end{center}
\subsection*{Note}
Formal verification: Statements S1--S14 are mechanically verified in Lean (including the head-level and stack-level clauses of Theorem~S4); see the repository documentation for a statement-to-file map.
