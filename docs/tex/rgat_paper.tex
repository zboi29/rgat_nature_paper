...
% Journal-style tuning (lightweight)
...
SI Lemmas~S2--S3 and SI Theorem~S4 for the Bridge Theorem, SI Theorem~S5 and
...
Joseph, Z. N. RGAT: Riemannian Geometric-Algebra Transformers (Paper) (v0.1.2). \emph{Zenodo} https://doi.org/10.5281/zenodo.18511210 (2026).
\end{thebibliography}
