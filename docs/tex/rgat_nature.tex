...
right eigenvector is constant (the principal left eigenvector is the stationary
distribution). This provides a spectral notion of diffusion time and mixing:
